  ...
  describe '#setup_board' do
    ...
    it "sets the initial board layout" do
      expect(subject.state['board']).to eq [
        { 'participant' => 0, 'rank' => 'R', 'space' => ['a', 1]},
        { 'participant' => 0, 'rank' => 'N', 'space' => ['b', 1]},
        { 'participant' => 0, 'rank' => 'B', 'space' => ['c', 1]},
        { 'participant' => 0, 'rank' => 'Q', 'space' => ['d', 1]},
        { 'participant' => 0, 'rank' => 'K', 'space' => ['e', 1]},
        { 'participant' => 0, 'rank' => 'B', 'space' => ['f', 1]},
        { 'participant' => 0, 'rank' => 'N', 'space' => ['g', 1]},
        { 'participant' => 0, 'rank' => 'R', 'space' => ['h', 1]},
        { 'participant' => 0, 'rank' => 'P', 'space' => ['a', 2]},
        { 'participant' => 0, 'rank' => 'P', 'space' => ['b', 2]},
        { 'participant' => 0, 'rank' => 'P', 'space' => ['c', 2]},
        { 'participant' => 0, 'rank' => 'P', 'space' => ['d', 2]},
        { 'participant' => 0, 'rank' => 'P', 'space' => ['e', 2]},
        { 'participant' => 0, 'rank' => 'P', 'space' => ['f', 2]},
        { 'participant' => 0, 'rank' => 'P', 'space' => ['g', 2]},
        { 'participant' => 0, 'rank' => 'P', 'space' => ['h', 2]},
        { 'participant' => 1, 'rank' => 'R', 'space' => ['a', 8]},
        { 'participant' => 1, 'rank' => 'N', 'space' => ['b', 8]},
        { 'participant' => 1, 'rank' => 'B', 'space' => ['c', 8]},
        { 'participant' => 1, 'rank' => 'Q', 'space' => ['d', 8]},
        { 'participant' => 1, 'rank' => 'K', 'space' => ['e', 8]},
        { 'participant' => 1, 'rank' => 'B', 'space' => ['f', 8]},
        { 'participant' => 1, 'rank' => 'N', 'space' => ['g', 8]},
        { 'participant' => 1, 'rank' => 'R', 'space' => ['h', 8]},
        { 'participant' => 1, 'rank' => 'P', 'space' => ['a', 7]},
        { 'participant' => 1, 'rank' => 'P', 'space' => ['b', 7]},
        { 'participant' => 1, 'rank' => 'P', 'space' => ['c', 7]},
        { 'participant' => 1, 'rank' => 'P', 'space' => ['d', 7]},
        { 'participant' => 1, 'rank' => 'P', 'space' => ['e', 7]},
        { 'participant' => 1, 'rank' => 'P', 'space' => ['f', 7]},
        { 'participant' => 1, 'rank' => 'P', 'space' => ['g', 7]},
        { 'participant' => 1, 'rank' => 'P', 'space' => ['h', 7]}
      ]
    end
      ...
      'white pawn moves one space' => {
        ...
        state_after: {
          board: [
            ...
            { 'participant' => 0, 'rank' => 'P', 'space' => ['b', 2]},
            { 'participant' => 0, 'rank' => 'P', 'space' => ['c', 2]},
            { 'participant' => 0, 'rank' => 'P', 'space' => ['d', 3]},
            { 'participant' => 0, 'rank' => 'P', 'space' => ['e', 2]},
            { 'participant' => 0, 'rank' => 'P', 'space' => ['f', 2]},
            { 'participant' => 0, 'rank' => 'P', 'space' => ['g', 2]},
            { 'participant' => 0, 'rank' => 'P', 'space' => ['h', 2]},
